...
config.PMDAQ_config.juiceChannel = 17;
...
config.PMDAQ_config.eventChannels = 0:15;
config.PMDAQ_config.strobeChannel = 16;
...
config.PMEyeLink_config.areaProportion = [0.5 0.5];
...
config.timeoutIncorrect = 2000e-3;
